...
<div class="drawer drawer-mobile">
  ...
  <div class="drawer-content flex flex-col items-center">
    ...
    <div class="navbar bg-base-300">
        ...
        <div class="flex-1 hidden lg:inline-block">
            <span class="px-5 normal-case text-xl font-bold">{ pageTitleValue }</span>
        </div>
        <div class="flex-1 inline-block lg:hidden">
            <a href="/" class="btn btn-ghost normal-case text-xl">Hello Sveltekit & daisyUI!</a>
        </div>
    </div>
  ...
  <div class="drawer-side">
    ...
    <div class="menu p-4 overflow-y-auto w-60 bg-neutral text-neutral-content">
        <a href="/" class="btn btn-ghost normal-case text-xl h-max hidden lg:inline-block">Hello Sveltekit & daisyUI!</a>
